...
abstract contract revert__claim__0x74 is NuggftV1Test {
    ...
    uint64 FRANKS_TOKEN = 500;

    uint64 CHARLIES_TOKEN = 501;
    uint64 DENNISS_TOKEN = 502;

    uint16 ITEM_ID;

    uint64 FRANKS_TOKEN_SELLING_ITEM_ID = 500;
    ...
    modifier revert__claim__0x74_setUp() {
        ...
        FRANKS_TOKEN_SELLING_ITEM_ID = (uint64(ITEM_ID) << 24) | FRANKS_TOKEN;
