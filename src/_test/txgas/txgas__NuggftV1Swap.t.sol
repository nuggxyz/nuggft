...
contract general__NuggftV1Swap is NuggftV1Test {
    ...
    function test__txgas__NuggftV1Swap__loan() public {
        nuggft.loan(LOAN_TOKENID);
    }

    function test__txgas__NuggftV1Swap__rebalance() public {
        nuggft.rebalance{value: 200 ether}(REBALANCE_TOKENID);
    }

    function test__txgas__NuggftV1Swap__liquidate() public {
