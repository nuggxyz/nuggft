...
abstract contract NuggftV1Swap is INuggftV1ItemSwap, INuggftV1Swap, NuggftV1Stake {
    ...
    function offer(uint160 tokenId) public payable override {
        ...
        assembly {
            ...
            mstore(0x00, sender)
            let offer__sptr := keccak256(0x00, 0x40)
        ...
        assembly {
            ...
            case 1 {
                if iszero(iszero(agency__cache)) {
                    panic(Error__a__0x97__ItemAgencyAlreadySet)
                }
                ...
                if eq(j, 16) {
                    panic(Error__m__0xA9__ProofDoesNotHaveItem)
                }
            ...
            default {
                ...
                if lt(floor, activeEps) {
                    panic(Error__F__0x70__FloorTooLow)
                }
